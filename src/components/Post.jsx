...
const Post = ({title, caption, postimg, likesNumber, id, comment}) => {
  ...
  return (
    <div className="max-w-xl mx-auto bg-white rounded-lg shadow-lg p-6 my-7" key={id}>

    <div className="flex items-center justify-between mb-4">
      <h2 className="text-2xl font-bold" style={{color: '#22b493'}}>{title}</h2>
    ...
    <div className="mb-4">
      ...
      <div className="rounded-lg pt-4 border-b">
        <input type="text" class=" border-gray-400 outline-none border-none" placeholder='Add a comment....'/>
    ...
    <div className="flex items-center justify-between space-x-2">
      <FaHeart
        ...
        onClick={handleLike}
      />
      <p className="text-gray-600 font-semibold">Liked by {likesNumber} people</p>
    </div>
